...
\author{\fnm{Can-Elian} \sur{Barth}}\email{canelian.barth@students.fhnw.ch}
\equalcont{These authors contributed equally to this work.}

\author{\fnm{Florian} \sur{Baumgartner}}\email{florian.baumgartner1@students.fhnw.ch}
\equalcont{These authors contributed equally to this work.}

\author{\fnm{Aaron} \sur{Brülisauer}}\email{aaron.bruelisauer@students.fhnw.ch}
\equalcont{These authors contributed equally to this work.}
...
\subsection{Reddit}\label{subsec2}

\subsection{X (Twitter)}\label{subsec3}

\subsection{Price Data}\label{subsec4}
